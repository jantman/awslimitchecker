...
from awslimitchecker.services.lambdafunc import _LambdafuncService
...
pbm = 'awslimitchecker.services.lambdafunc'  # module patch base
pb = '%s._LambdafuncService' % pbm  # class patch pase


class Test_LambdafuncService(object):

    def test_init(self):
        """test __init__()"""
        cls = _LambdafuncService(21, 43)
        assert cls.service_name == 'Lambdafunc'
        assert cls.api_name == 'lambdafunc'
