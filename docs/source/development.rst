...
* each :py:class:`~awslimitchecker.services.base.AwsLimitCheckerService` subclass
...
All Services are sublcasses of :py:class:`~awslimitchecker.services.base.AwsLimitCheckerService`
